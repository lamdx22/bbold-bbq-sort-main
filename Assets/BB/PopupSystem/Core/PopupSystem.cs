...
#if UNITY_EDITOR
        public PopupType testPopup = PopupType.PopupBonusBoosterFire;

        public void ShowPopup()
        {
            ShowPopup(testPopup, CurrentPopupBehaviour.Close, true);
        }
#endif
    }
}
...
#if UNITY_EDITOR
[CustomEditor(typeof(Popup.PopupSystem))]
public class PopupSystemEditor : Editor
{
    Popup.PopupSystem popupSystem;

    void OnEnable()
    {
        popupSystem = target as Popup.PopupSystem;
    }
